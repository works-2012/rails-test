...
(Широко используется в реальной работе). Проект можно разместить на [bitbucket.org](http://bitbucket.org), 
[github.com](http://github.com) или любом другом vcs-сервере.
